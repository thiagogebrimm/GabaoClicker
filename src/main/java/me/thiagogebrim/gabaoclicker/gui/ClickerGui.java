...
public class ClickerGui {
	...
	public JFrame frame = new JFrame("Gabão Clicker");

	public JPanel mainPane = new JPanel(null);
	public JPanel titleBar = new JPanel(null);
	public JPanel dropdown = new JPanel(null);

	public JLabel titleText = new JLabel("Gabão Clicker");
	public JLabel cpsRange = new JLabel("Faixa de CPS");
	...
	public JLabel toggleKeyText = new JLabel("Botão Alternar");
	...
	public JCheckBox overlayBox = new JCheckBox("Sobrepor", true);
	public JCheckBox rightClickBox = new JCheckBox("Clique direito", false);
	...
	private void setupFrame() {
		...
		if (System.getProperty("os.name").toLowerCase().contains("mac")) {
			Application.getApplication().setDockIconImage(
					new ImageIcon(AutoClicker.class.getClassLoader().getResource("assets/GabaoClicker.png")).getImage());
		} else {
			frame.setIconImage(
					new ImageIcon(AutoClicker.class.getClassLoader().getResource("assets/GabaoClicker.png")).getImage());
		}
	...
	private void setupMisc() {
		try {
			...
			cpsNumber.setFont(font.deriveFont(Font.PLAIN, 63));
